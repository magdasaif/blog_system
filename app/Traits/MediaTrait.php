...
trait MediaTrait
{
   ...
   #==========================================================================================================#
   // public function UpdateMedia($request,$model_data,$media_input_name,$collection_name,$new_image_name,$model_name,$model_id){
   //    # Check if this model has a image or not 
   //    $CheckImageExist = $this->CheckFileExistMediaWithMediaLibrary($model_name,$model_id,$collection_name);
   ...
   //    // if($model){
   //       return  $this->StoreMediaWithMediaLibrary($request,$model_data,$media_input_name,$collection_name);
   //    // }
   // }
   #==========================================================================================================#
